# audio-track-routing-service Specification

## Purpose
Centralize audio routing decisions — codec detection, channel capability assessment, backend route selection, and initial track selection — into a dedicated service, decoupling audio-related logic from `VideoPlayerController`.
