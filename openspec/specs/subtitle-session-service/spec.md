# subtitle-session-service Specification

## Purpose
Centralize subtitle runtime session management — track loading, activation state, delay adjustment, and external subtitle appending — into a dedicated service per playback session, decoupling subtitle lifecycle from `VideoPlayerController`.
