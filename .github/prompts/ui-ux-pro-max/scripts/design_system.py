...
def format_master_md(design_system: dict, project_slug: str) -> str:
...
def format_page_override_md(design_system: dict, page_name: str, project_slug: str, page_query: str = None) -> str:
